...
namespace Grid {
  ...
  public:
    ...
    virtual void RedBlackSource(Matrix & _Matrix,const Field &src, Field &src_e,Field &src_o)
    {
      ...
      /////////////////////////////////////////////////////
      _Matrix.MooeeInv(src_e,tmp);     GRID_ASSERT(  tmp.Checkerboard() ==this->cbParityNeg);
      _Matrix.Meooe   (tmp,Mtmp);      GRID_ASSERT( Mtmp.Checkerboard() ==this->cbParity);     
      tmp=src_o-Mtmp;                  GRID_ASSERT(  tmp.Checkerboard() ==this->cbParity);     
    ...
    virtual void RedBlackSolution(Matrix & _Matrix,const Field &sol_o, const Field &src_e_c,Field &sol)
    {
      ...
      // sol_e = M_ee^-1 * ( src_e - Meo sol_o )...
      ///////////////////////////////////////////////////
      _Matrix.Meooe(sol_o,tmp);        GRID_ASSERT(  tmp.Checkerboard()   ==this->cbParityNeg);
      src_e = src_e-tmp;               GRID_ASSERT(  src_e.Checkerboard() ==this->cbParityNeg);
      _Matrix.MooeeInv(src_e,sol_e);   GRID_ASSERT(  sol_e.Checkerboard() ==this->cbParityNeg);
     
      setCheckerboard(sol,sol_e); GRID_ASSERT(  sol_e.Checkerboard() ==this->cbParityNeg);
      setCheckerboard(sol,sol_o); GRID_ASSERT(  sol_o.Checkerboard() ==this->cbParity );
    }
    virtual void RedBlackSolve   (Matrix & _Matrix,const Field &src_o, Field &sol_o)
    {
      SchurStaggeredOperator<Matrix,Field> _HermOpEO(_Matrix);
      this->_HermitianRBSolver(_HermOpEO,src_o,sol_o);  GRID_ASSERT(sol_o.Checkerboard()==this->cbParity);
    };
  ...
  public:
    ...
    virtual void RedBlackSource(Matrix & _Matrix,const Field &src, Field &src_e,Field &src_o)
    {
      ...
      _HermOpEO.MpcDag(tmp,src_o);     GRID_ASSERT(src_o.Checkerboard() ==this->cbParity);       
    ...
    virtual void RedBlackSolution(Matrix & _Matrix,const Field &sol_o, const Field &src_e,Field &sol)
    {
      ...
      ///////////////////////////////////////////////////
      _Matrix.Meooe(sol_o,tmp);          GRID_ASSERT(  tmp.Checkerboard()   ==this->cbParityNeg);
      src_e_i = src_e-tmp;               GRID_ASSERT(  src_e_i.Checkerboard() ==this->cbParityNeg);
      _Matrix.MooeeInv(src_e_i,sol_e);   GRID_ASSERT(  sol_e.Checkerboard() ==this->cbParityNeg);
  ...
  template<class Field> class NonHermitianSchurRedBlackDiagMooeeSolve : public SchurRedBlackBase<Field> 
  {
    public:
      ...
      virtual void RedBlackSource(Matrix& _Matrix, const Field& src, Field& src_e, Field& src_o)
      {
        ...
        _Matrix.MooeeInv(src_e, tmp);   GRID_ASSERT(   tmp.Checkerboard() == this->cbParityNeg );
        _Matrix.Meooe   (tmp, Mtmp);    GRID_ASSERT(  Mtmp.Checkerboard() == this->cbParity  );     
        src_o -= Mtmp;                  GRID_ASSERT( src_o.Checkerboard() == this->cbParity  );     
      }
      ...
      virtual void RedBlackSolve(Matrix& _Matrix, const Field& src_o, Field& sol_o)
      {
        ...
        this->_HermitianRBSolver(_OpEO, src_o, sol_o);  GRID_ASSERT(sol_o.Checkerboard() == this->cbParity);
      }
  ...
  SchurRedBlackDiagTwoSolve(OperatorFunction<Field> &HermitianRBSolver, const bool initSubGuess = false,
    ...
    virtual void RedBlackSolution(Matrix & _Matrix,const Field &sol_o, const Field &src_e,Field &sol)
    {
      ...
      // sol_e = M_ee^-1 * ( src_e - Meo sol_o )...
      ///////////////////////////////////////////////////
      _Matrix.Meooe(sol_o_i,tmp);    GRID_ASSERT(  tmp.Checkerboard()   ==this->cbParityNeg);
      tmp = src_e-tmp;               GRID_ASSERT(  src_e.Checkerboard() ==this->cbParityNeg);
      _Matrix.MooeeInv(tmp,sol_e);   GRID_ASSERT(  sol_e.Checkerboard() ==this->cbParityNeg);
     
      setCheckerboard(sol,sol_e);    GRID_ASSERT(  sol_e.Checkerboard() ==this->cbParityNeg);
      setCheckerboard(sol,sol_o_i);  GRID_ASSERT(  sol_o_i.Checkerboard() ==this->cbParity );
    };
